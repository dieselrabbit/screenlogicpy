...
class VALUE:
    ...
    EQUIP_SOLAR = "solar"
    EQUIP_SOLAR_AS_HEAT_PUMP = "solar_as_heat_pump"
    EQUIP_CHLORINATOR = "chlorinator"
    EQUIP_SPA_SIDE_REMOTE = "spa_side_remote"
    EQUIP_ULTRATEMP_THEMALFLO = "ultratemp_thermalflo"
    EQUIP_HAS_COOLING = "has_cooling"
    EQUIP_INTELLICHEM = "intellichem"
    FIRMWARE = "firmware"
    FLAGS = "flags"
    ...
    SCG_FLAGS = "scg_flags"
    SCG_POOL_SETPOINT = "scg_pool_setpoint"
    SCG_PRESENT = "scg_present"
    SCG_SALT_PPM = "scg_salt_ppm"
    SCG_SPA_SETPOINT = "scg_spa_setpoint"
    SCG_STATE = "scg_state"
    SCG_SUPER_CHLOR_TIMER = "scg_super_chlor_timer"
